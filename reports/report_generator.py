...
@page {
    ...
    /* Footer */
    @bottom-left {
        content: "Generated by: TriageHound v2.0"; font-size: 8pt;
...
def _build_cover_page(case_info, report_id, now_str):
    ...
    <div class="cover-page">
        ...
        <table class="case-info">
            ...
            <tr><th>Diagnostic Engine</th><td>TriageHound v2.0</td></tr>
        </table>
...
def _build_v2_executive_summary(investigation_summary):
    """Build the v2.0 Executive Summary page with confidence score."""
...
def _build_v2_findings_section(investigation_summary):
    """Build the v2.0 Correlated Findings section."""
    if not investigation_summary:
        return ''
...
def _build_v2_antiforensics_section(investigation_summary):
    """Build the v2.0 Anti-Forensics Detection section."""
    if not investigation_summary:
        return ''
...
def _build_v2_attack_chain_section(investigation_summary):
    """Build the v2.0 Attack Chain Reconstruction section."""
    if not investigation_summary:
        return ''
...
def generate_pdf_report(case_info, timeline_data, output_path, db_manager=None,
    ...
    Args:
        ...
        investigation_summary:  dict from FindingsEngine (v2.0 intelligence)
    """
